...
module GameData
	...
	RECIPES = [
		...
		Recipe.new(WOOD_REFINERY, [], {WOOD => 2_500}, {WOOD_CRYSTAL => 100}, 200),
		...
		#    暗の剣準備
		Recipe.new(ANCIENT_REFINERY, [], {INFERIOR_MAGIC_CRYSTAL => 250, COAL => 25_000, LIME => 25_000}, {INFERIOR_DARK_CRYSTAL => 10}, 1000),
		#  暗の剣
		...
		Recipe.new(INFERIOR_MAGIC_WORKBENCH, [FIRE_FURNACE, WOOD_REFINERY, METAL_REFINERY, ANCIENT_REFINERY],
			...
			{MAGIC_CRYSTAL => 20}, 1500),
		#   魔法結晶量産
		Recipe.new(FIRE_FURNACE, [MAGIC_WORKBENCH], {FIRE_CRYSTAL => 200_000}, {MAGIC_CRYSTAL => 10}, 500),
		Recipe.new(WOOD_REFINERY, [MAGIC_WORKBENCH], {WOOD_CRYSTAL => 32_000}, {MAGIC_CRYSTAL => 10}, 300),
		Recipe.new(METAL_REFINERY, [MAGIC_WORKBENCH, LARGE_FURNACE],
			...
			{MAGIC_CRYSTAL => 10}, 500),
		Recipe.new(ANCIENT_REFINERY, [MAGIC_WORKBENCH], {COAL => 120_000, LIME => 120_000}, {MAGIC_CRYSTAL => 10}, 500),
		#   炎の結晶
